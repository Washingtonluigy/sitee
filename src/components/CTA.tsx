    ...
    <section className="py-12 md:py-16 bg-gradient-to-br from-purple-600 via-purple-600 to-purple-700 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-10">
        <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-3 md:px-4 py-2 rounded-full mb-4 md:mb-6 text-xs md:text-sm">
          ...
          <span className="font-medium text-white" translate="no">Comece sua jornada de saúde</span>
        </div>

        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 md:mb-5 leading-tight" translate="no">
          Pronto para começar?
        </h2>

        <p className="text-sm sm:text-base md:text-lg text-purple-100 mb-6 md:mb-8 leading-relaxed max-w-2xl mx-auto px-4" translate="no">
